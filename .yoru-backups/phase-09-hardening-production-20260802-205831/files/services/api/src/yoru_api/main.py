...
from yoru_api.core.middleware import RequestContextMiddleware, SecurityHeadersMiddleware
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    async def root() -> dict[str, str]:
        return {"name": "Yoru API", "version": __version__, "stage": "partner-copilot"}
