...
export function CheckoutFlow() {
  ...
  const totals = useMemo(() => productCheckoutTotals(state.cart, deliveryMethod), [deliveryMethod, state.cart]);
  ...
  function confirmOrder() {
    setPending(true);
    const order = createOrder({ address, deliveryMethod, paymentMethod });
