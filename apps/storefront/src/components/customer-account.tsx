    ...
    <main className="account-page">
      <section className="account-hero">
        ...
        <div>
          ...
          <h1>Halo, {session.user.full_name.split(" ")[0]}.</h1>
      ...
      <section className="account-dashboard-grid">
        <Link href="/history">
          <span className="account-tile-icon">
            <Icon name="clock" width="22" />
          </span>
          <div>
            <strong>Riwayat transaksi</strong>
            <span>Pembayaran, pengiriman, booking, dan refund</span>
          </div>
        ...
        <Link href="/orders">
          ...
          <div>
            ...
            <span>{state.orders.length} order tersimpan</span>
          </div>
          <Icon name="arrow" width="18" />
        </Link>
        <Link href="/bookings">
          <span className="account-tile-icon">
            <Icon name="calendar" width="22" />
          </span>
          <div>
            <strong>Booking</strong>
            <span>{state.bookings.length} layanan tersimpan</span>
          </div>
          <Icon name="arrow" width="18" />
        </Link>
        <Link href="/assistant">
          ...
          <div>
            <strong>Yoru Advisor</strong>
            <span>Bantu pilih produk dan layanan</span>
          </div>
          <Icon name="arrow" width="18" />
        </Link>
        <Link href="/products">
          ...
          <div>
            ...
            <span>{state.favorites.length} item disimpan</span>
          </div>
          <Icon name="arrow" width="18" />
        </Link>
      </section>
      <section className="account-information">
        <div>
          ...
          <dl>
            ...
            <div>
              <dt>Role storefront</dt>
              <dd>Customer</dd>
            </div>
            <div>
              <dt>Session</dt>
              <dd>Secure HttpOnly cookie</dd>
            </div>
          </dl>
        </div>
        <div className="account-security-card">
          <Icon name="shield" width="28" />
          <h2>Akun dan transaksi tetap terpisah dari console partner.</h2>
          <p>
            Storefront hanya memberi akses customer. Otorisasi partner dan super admin tetap berada
            di console dan API.
          </p>
        </div>
      </section>
